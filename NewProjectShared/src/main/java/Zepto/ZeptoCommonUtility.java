...
public class ZeptoCommonUtility {
...
//		driver.findElement(By.xpath("//button[@type='button']//div//div//p")).click();
		CommonUserUtilityScrapper.waitHelper(driver, "//p[text()='Type manually']");
		...
		CommonUserUtilityScrapper.waitHelper(driver, "//h4[contains(text(),'"+location+"')]");
		...
		CommonUserUtilityScrapper.waitHelper(driver, "//button[@aria-label='Confirm Action']");

...
//	Location setup:
	...
	public void SwiggyLocationSetup(RemoteWebDriver driver, String location) {
		...
		UserUtilitySwiggy.waitHelper(driver, "//input[@type='text']");
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys(location, Keys.ENTER);
		UserUtilitySwiggy.waitHelper(driver, "//span//span[contains(text(),'"+location+"')]");
...
//	Product details Scraping:
	...
	public List<String> productDetailsScrapping(RemoteWebDriver driver) {
		...
		String StockAvailability = "1";
			...
			UserUtilitySwiggy.waitHelper(driver, "//div[@data-testid='item-name']");
			String ItemName = driver.findElement(By.xpath("//div[@data-testid='item-name']")).getText();

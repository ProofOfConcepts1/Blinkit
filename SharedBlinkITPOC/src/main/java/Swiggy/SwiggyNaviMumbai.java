...
public class SwiggyNaviMumbai {
	...
	public void dataScrapping(int startRowNum, int endRowNum, String OutputFileName) {
		...
		UserUtilitySwiggy userUtility1 = new UserUtilitySwiggy(UserUtilitySwiggy.InputDataFilePath1, "Input data",
...
//				int Count = Integer.valueOf(Total_product);
				...
				try {
					...
					if (driver == null) {
						...
						Swiggy.SwiggyLocationSetup(driver, "Navi Mumbai");
					}
					else {
						try {
							driver.get(URL);

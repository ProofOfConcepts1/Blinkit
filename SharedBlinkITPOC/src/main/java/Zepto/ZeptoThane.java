...
public class ZeptoThane {
	...
	public void dataScrapping(int startRowNum, int endRowNum, String OutputFileName) {
		...
		UserUtilityZepto userUtility1 = new UserUtilityZepto(UserUtilityZepto.InputDataFilePath2,"Input data", "Locators", OutputFileName);
...
//				int Count = Integer.valueOf(Total_product);
				...
				try {
					...
					if (driver == null) {
						...
						Zepto.ZeptoLocationSetup(driver, "Thane");
					}
					else {
						try {
							driver.get(URL);
